...
var errorValidMail = 'E-mail не валидный.',
...
var categorySelectBtn = document.querySelector('.header-nav-select'),
    categorySelect = document.querySelector('.category-select'),
    indexForm = document.querySelector('#head-banner-form'),
    orderForm = document.querySelector('#order-form');
var headerTelBtn = document.querySelector('.header-tel-btn'),
...
closeTelPopupBtn.addEventListener('click', function () {
...
closeMenuPopupBtn.addEventListener('click', function () {
  document.body.classList.remove('body-popup-active');
...
indexForm && indexForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = e.target;
  var item = form.querySelector('[name="item"]').value;
  window.location.href = "/order?".concat(Object(query_string__WEBPACK_IMPORTED_MODULE_0__["stringify"])({
    item: item
  }));
});
